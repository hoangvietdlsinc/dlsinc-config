Vagrant.configure("2") do |ansible_lab|
    ansible_lab.vm.provision "shell", inline: "sudo yum update -y"
    ansible_lab.vm.define "ansiblevm01" do |ansiblevm01|
      ...
      ansiblevm01.vm.network "private_network", type: "dhcp"
    ...
    ansible_lab.vm.define "webserver01" do |webserver01|
      ...
      webserver01.vm.network "private_network", ip: "10.100.100.10"
    ...
    ansible_lab.vm.define "database01" do |database01|
      ...
      database01.vm.network "private_network", ip: "10.100.100.20"
